...
def process_song_file(cur, filepath):
    """
    Processes songs log file and inserts them in the table as shown below 
    Parameters:
    - cur: cursor object
    ...
    for val in df.values:
        artist_id, artist_latitude, artist_location, artist_longitude, artist_name, duration, num_songs, song_id, title, year = val
...
def process_log_file(cur, filepath):
    """
    Processes user activiy log file and inserts them in the table as shown below
    Parameters:
    - cur : cursor object
    - filepath: path of file to be processed
    - return None
...
def process_data(cur, conn, filepath, func):
    """
    Process data present in filepath using function names present in func
...
def main():
    """
    Main function where connection is made to the database and closed after .
    - return None
    """
